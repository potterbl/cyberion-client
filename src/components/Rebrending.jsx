...
const Rebrending = () => {
    ...
    let scale = useTransform(scrollY, [top + window.innerHeight, bottom - window.innerHeight * 1.5], [2, 1])
    let y = useTransform(scrollY, [top + window.innerHeight, bottom - window.innerHeight * 1.5], ['50%', '0%'])
